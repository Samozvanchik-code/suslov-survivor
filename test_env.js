...
function поднять(опции) {
  ...
  vm.runInContext(`globalThis.__ = {
    ...
    ВОЛНЫ, ТЕЛЕГРАФ, СНАРЯД, МАНИФЕСТ, СПРАЙТ, МАНИФЕСТ_ЗВУКОВ, ГОЛОС_КАРТЫ, проиграть, вызватьБосса, обновитьБосса, завестиТелеграф,
    ...
    начатьАтакуБосса, интервалАтакиБосса,
    // пакет боссов: ДЕЛИТЕЛЬ-ПАПА, ДВОЙНИК, финал с дополнительным временем
    РОДЫ, ДВОЙНИК_КОПИЯ, ФИНАЛ, ДЕЛИТЕЛЬ, КРИК, ПРАЙМ, ОТЧЁТ, ГАНТЕЛЯ,
    родитьДелителя, обновитьРоды, снятьКопию, гарнизонДвойника, обновитьДвойника,
    уволитьСпутника, обновитьУвольнения, обновитьФинал,
    пересобратьТараканов, пересобратьЩенков,
    начатьЗабег, завершитьЗабег, шагЛогики, нарисоватьМир, нарисоватьИнтерфейс,
    ...
    обновитьСсылку, ссылкаОтзыва, внешниеСсылки
